...
func NewGoCdkStack(scope constructs.Construct, id string, props *GoCdkStackProps) awscdk.Stack {
	...
	// Lambda
	myFunction :=  awslambda.NewFunction(stack, jsii.String("myFirstGoLambda"), &awslambda.FunctionProps{
	...
	// API
	api := awsapigateway.NewRestApi(stack, jsii.String("myGoApiGateway"), &awsapigateway.RestApiProps{
